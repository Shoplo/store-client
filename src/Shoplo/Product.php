...
class Product extends Resource
{
    ...
    public function count($collection_id = 0, $params = array())
    {
        ...
        return ($collection_id > 0) ? $this->send(
            $this->prefix."products/count?collection_id=".$collection_id."&".$params
        ) : $this->send($this->prefix."products/count?".$params);
    }
